...
import com.tripmate.dto.PhoneUpdateDto;
import com.tripmate.dto.MemberFormDto;
import com.tripmate.dto.MemberSearchDto;
import com.tripmate.dto.MemberUpdateDto;
...
public class MemberService implements UserDetailsService {
    ...
    public void updatePhone(PhoneUpdateDto phoneUpdateDto) {
        ...
        memberRepository.findByPhone(phoneUpdateDto.getPhone())
                .ifPresent(m -> {
        ...
        // 전화번호를 업데이트합니다
        member.setPhone(phoneUpdateDto.getPhone());
    }
    ...
    public boolean isSocialLoginUser() {
        ...
        return "SOCIAL_LOGIN".equals(member.getPassword());
    }
    ...
    public boolean hasDefaultPhone() {
        ...
        return "000-0000-0000".equals(member.getPhone());
    }
    ...
    private void validateDuplicateMember(MemberFormDto memberFormDto) {
        ...
        memberRepository.findByPhone(memberFormDto.getPhone()).ifPresent(m -> {
    ...
    public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
        ...
        return new com.tripmate.config.CustomUserDetails(member);
    }
    ...
    public void resetPassword(String email, String newPassword) {
        ...
        System.out.println("변경 전 비밀번호: " + member.getPassword());
        member.setPassword(encodedPw);
        memberRepository.save(member);
        System.out.println("변경 후 비밀번호: " + member.getPassword());
    }
