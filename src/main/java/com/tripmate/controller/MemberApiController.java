...
import com.tripmate.config.JwtTokenProvider;
import com.tripmate.dto.*;
import com.tripmate.dto.MemberDto;
...
public class MemberApiController {
    ...
    public ResponseEntity<?> signUp(
        ...
        try {
            memberFormDto.setProfileImgFile(profileImgFile);
    ...
    public ResponseEntity<?> login(@RequestBody LoginDto loginDto) {
        ...
        try {
            ...
            if (member != null) {
                System.out.println("가져온 member_ProfileImg: " + member.getProfileImg());
            } else {
            ...
            return ResponseEntity.ok(Map.of(
                ...
                "profileImg", member.getProfileImg() != null ? member.getProfileImg() : "",
                "nickname", member.getNickname(),
                "memberId", member.getId() //추가 - 결제 검증때 필요
    ...
    public ResponseEntity<Long> getMemberIdByEmail(@RequestParam String email) {
      ...
      return ResponseEntity.ok(member.getId()); // 정확한 필드명
    }
